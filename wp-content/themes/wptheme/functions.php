...
register_sidebar( array(
    ...
    register_sidebar( array(
		'name'          => esc_html__( 'Footer One', 'wptheme' ),
		'id'            => 'footer-1',
		'description'   => esc_html__( 'Add widgets here.', 'wptheme' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
    ...
    register_sidebar( array(
		'name'          => esc_html__( 'Footer Two', 'wptheme' ),
		'id'            => 'footer-2',
		'description'   => esc_html__( 'Add widgets here.', 'wptheme' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
    ...
    register_sidebar( array(
		'name'          => esc_html__( 'Footer Three', 'wptheme' ),
		'id'            => 'footer-3',
		'description'   => esc_html__( 'Add widgets here.', 'wptheme' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
function wptheme_scripts() {
	...
	wp_enqueue_style( 'carouselcss', get_template_directory_uri() . '/css/owl.carousel.min.css');
